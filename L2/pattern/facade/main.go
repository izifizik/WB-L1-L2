...
/*
Фасад дает легкость взаимодействия с интерфейсом
Вся логика взаимодействия между сущностями скрыта
Все что нужно это вызвать метод в котором пойдет серия вызовов
*/
